...
* **Background workers and polling loops do not stay running** because you
  deployed a web service that sleeps when nothing is calling it. If you needed
  something to happen on a schedule, add a cron job instead; if you were polling
  an external API for updates, take its webhook instead.
